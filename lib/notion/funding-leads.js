...
function buildProperties(request, requestId, attribution) {
  ...
  if (attribution && attribution.trackingLinkPageId) {
    properties['Tracking Link'] = { relation: [{ id: attribution.trackingLinkPageId }] };
  }
