...
(function initDashboardDataAdapter(window, document) {
  ...
  function mapLead(item, partnerId) {
    return {
      ...
      documentStatus: item.document_status || null,
      followUpAt: item.follow_up_at || item.next_action_at || null,
      followUpState: item.follow_up_state || (item.document_status === "requested" ? "waiting_on_client" : "open"),
